...
const steps: TourStep[] = [
  ...
  { path: "/lista-de-compras", icon: "📦", kicker: "Cobertura de estoque", title: "Defina os dias para manter estoque", text: "Esse número informa por quantos dias a compra deve sustentar a operação até a próxima reposição.", improvement: "Quanto maior o número, maior será a quantidade sugerida. Ajuste conforme frequência de compra, espaço e validade.", bullets: ["Dias de cobertura", "Frequência de compra", "Validade"] },
  { path: "/lista-de-compras", icon: "🚚", kicker: "Prazo do fornecedor", title: "Considere o tempo de entrega", text: "O prazo de entrega é o intervalo entre fazer o pedido e receber a mercadoria.", improvement: "O sistema soma esse prazo à cobertura para evitar que o estoque acabe enquanto o pedido está a caminho.", bullets: ["Pedido até recebimento", "Evita ruptura", "Soma à cobertura"] },
  { path: "/lista-de-compras", icon: "📚", kicker: "Histórico do item", title: "Abra o item para conferir a origem", text: "Clique no nome de um item da lista para abrir seu histórico e entender entradas, custos e dados usados na sugestão.", improvement: "Confira o histórico quando uma quantidade sugerida parecer muito alta ou muito baixa.", bullets: ["Clique no item", "Histórico de entradas", "Audite a sugestão"] },
