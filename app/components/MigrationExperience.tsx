...
const steps: TourStep[] = [
  ...
  { path: "/dashboard", target: { selector: '[data-tour="cmv-table-item-history"]' }, icon: "🔎", kicker: "Detalhamento e auditoria", title: "Abra os detalhes e históricos", text: "Cada linha mostra estoque inicial, entradas, estoque final, saídas, custo médio e CMV. Clique no nome do primeiro item destacado para conferir os dados que formaram o resultado.", improvement: "O círculo verde indica exatamente onde clicar. O guia avança somente depois de abrir o item.", bullets: ["Cálculo por item", "Histórico de entradas", "Rastreabilidade"] },
  ...
  { path: "/fichas-tecnicas", target: { selector: '[data-tour="sheet-new"]' }, icon: "➕", kicker: "Monte uma receita", title: "Abra uma nova ficha", text: "Aqui começa a composição de um produto vendido.", improvement: "Clique no botão destacado. O guia permanecerá na ficha e mostrará o primeiro campo do formulário.", bullets: ["Ingredientes", "Quantidade", "Rendimento"] },
