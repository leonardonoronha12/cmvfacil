...
const steps: TourStep[] = [
  ...
  { path: "/inventario", target: { selector: '[role="dialog"] input[placeholder="DD/MM/AAAA"]' }, passive: true, icon: "🗓️", kicker: "Passo 1 — escolha a data", title: "Informe o dia da contagem", text: "Clique no campo destacado e selecione no calendário a data em que o estoque está sendo contado.", improvement: "Se a data correta já estiver preenchida, apenas confira. Quando terminar, clique em Continuar no guia. Use uma data diferente se já existir uma contagem para hoje.", bullets: ["Clique no campo", "Escolha ou confira a data", "Depois clique em Continuar"] },
  ...
  { path: "/inventario", target: { selector: 'input[data-inv-pending="1"]' }, passive: true, icon: "⌨️", kicker: "Passo 4 — registre a quantidade", title: "Digite o estoque contado", text: "No item pendente, informe a quantidade física encontrada usando a unidade mostrada ao lado: Kg, g, L, ml ou Und.", improvement: "Digite o valor e pressione Enter, ou toque fora do campo. O item passa para Contabilizados. Para 700 gramas em um item medido em Kg, digite 0,700.", bullets: ["Respeite a unidade", "Use vírgula nos decimais", "Pressione Enter"] },
  ...
  { path: "/entradas", target: { selector: '[role="dialog"] select' }, passive: true, icon: "🚚", kicker: "Passo 1 — fornecedor", title: "Selecione de quem você comprou", text: "Clique no campo destacado e escolha o fornecedor que aparece na nota.", improvement: "Se ele não estiver cadastrado, use ADD Fornecedor. Depois de escolher, clique em Continuar no guia.", bullets: ["Abra a lista", "Escolha o fornecedor", "Depois clique em Continuar"] },
  { path: "/entradas", target: { selector: '[role="dialog"] input' }, passive: true, icon: "🗓️", kicker: "Passo 2 — recebimento", title: "Confira a data da nota", text: "Informe o dia em que os produtos foram recebidos. Essa data organiza o histórico e o custo do período correto.", improvement: "Clique no campo, escolha a data no calendário e depois clique em Continuar.", bullets: ["Escolha a data", "Confira o período", "Continue no guia"] },
  ...
  { path: "/entradas", target: { selector: '[role="dialog"]' }, passive: true, icon: "🧮", kicker: "Passo 4 — produtos", title: "Adicione os itens comprados", text: "Pesquise o insumo, informe quantidade, unidade, subtotal ou custo unitário e use o botão adicionar.", improvement: "Todos os insumos aparecem no catálogo. O conversor ajusta caixas, unidades, quilos e litros. Confira cada linha antes de terminar.", bullets: ["Escolha o insumo", "Informe quantidade e custo", "Adicione e confira"] },
  ...
  { path: "/insumos", target: { text: "Importar", tag: "button" }, passive: true, icon: "📥", kicker: "Cadastro em quantidade", title: "Importe uma planilha", text: "Além do cadastro individual, você pode trazer vários itens por planilha.", improvement: "Use o modelo esperado, revise a prévia e confirme somente depois de verificar nomes, categorias e unidades.", bullets: ["Modelo de planilha", "Prévia", "Validação"] },
  ...
  { path: "/insumos", target: { selector: '[role="dialog"] select' }, passive: true, icon: "⚖️", kicker: "Unidades e conversão", title: "Defina como o item é medido", text: "A unidade principal determina como o estoque será contado e calculado.", improvement: "Quando a compra chega em caixa, pacote ou fardo, use a conversão para relacionar a embalagem à unidade real do estoque.", bullets: ["Kg e g", "L e ml", "Caixas e unidades"] },
  ...
  { path: "/lista-de-compras", target: { selector: 'select' }, icon: "📅", kicker: "Defina a necessidade", title: "Comece pelo período", text: "A lista compara inventários para entender o estoque disponível e sugerir reposição.", improvement: "Clique no campo destacado e escolha uma opção quando houver inventários cadastrados.", bullets: ["Inventário inicial", "Inventário final", "Sugestão calculada"] },
  ...
  { path: "/ajustes", target: { selector: 'input[type="email"]' }, passive: true, icon: "🔐", kicker: "Permissões seguras", title: "Preencha o convite", text: "Informe nome, e-mail e escolha se a pessoa será administradora ou colaboradora.", improvement: "Depois do convite, use a mesma área para editar permissões ou remover acessos que não devem continuar ativos.", bullets: ["Convidar", "Editar acesso", "Remover usuário"] },
