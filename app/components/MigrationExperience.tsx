...
const steps: TourStep[] = [
  ...
  { path: "/inventario", target: { selector: '[role="dialog"]' }, passive: true, icon: "🗓️", kicker: "Cadastro da contagem", title: "Conheça todos os campos", text: "Nesta janela você escolhe a data, define os setores e inicia a contagem que ficará disponível para preenchimento.", improvement: "Confira o formulário inteiro destacado. O inventário só é criado quando você confirma; durante o tutorial apenas observe e avance.", bullets: ["Data do inventário", "Setores", "Confirmação segura"] },
  ...
  { path: "/entradas", target: { selector: '[role="dialog"]' }, passive: true, icon: "🧮", kicker: "Cadastro completo da nota", title: "Veja como os itens são lançados", text: "O modal reúne fornecedor, data, responsável, busca de insumos, quantidade, unidade, custo e subtotal.", improvement: "Todos os insumos aparecem no catálogo. O conversor trata caixas, unidades, quilos e litros, e o histórico preserva fornecedor e custo de cada entrada.", bullets: ["Todos os insumos", "Conversor automático", "Custo e subtotal"] },
