...
const steps: TourStep[] = [
  ...
  { path: "/dashboard", target: { selector: '[data-tour="cmv-items-table"]' }, passive: true, icon: "🔎", kicker: "Auditoria do resultado", title: "Abra os detalhes e históricos", text: "Quando um valor parecer fora do padrão, clique no item da tabela para conferir todas as entradas e os custos que formaram aquele resultado.", improvement: "Corrija sempre o cadastro, a entrada ou o inventário de origem; assim o painel inteiro é recalculado mantendo a rastreabilidade.", bullets: ["Histórico de entradas", "Custo médio", "Rastreabilidade"] },
