...
function buildAutoSyncTypes() {
  return [
    ...
    "itens_fornecedores",
    "itens_inventarios",
    "inventario_contabilizado",
    "inventarios_contabilizados",
    "inventario_contabilizacao",
    "inventarios_contabilizacao",
    "Itens_lista_compras",
    "itens_lista_compras",
    "equivalencias",
    "notas_fiscais",
    ...
    "motivos_desperdicio",
    "motivos",
    "motivos_de_desperdicio",
    "motivos_de_desperdicios",
    "Motivos_de_Desperdicio",
    "Motivos_de_Desperdicios",
    "desperdicios",
    "inventarios",
    ...
    "etiqueta",
    "Etiquetas",
    "pre_preparo_etiqueta",
    "pre_preparo_etiquetas",
    "etiquetas_pre_preparo",
    "Etiquetas_Pre_Preparo",
    "faturamentos",
    "qtd_compra_reals",
    "qtd_compra_real",
