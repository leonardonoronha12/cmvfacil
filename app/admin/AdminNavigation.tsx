...
const monitoring=[["/admin/observabilidade","▦","Visão geral"],["/admin/usuarios","◎","Acessar usuários"],["/admin/geografia","⌖","Mapa e regiões"],["/admin/atividade","↗","Atividade"],["/admin/erros","!","Erros e desempenho"]] as const;
